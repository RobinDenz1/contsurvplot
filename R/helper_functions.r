...
remove_unnecessary_covars <- function(data, time, status, variable, model) {
  ...
  needed_covars <- c(time, status, variable, model_vars)
...
prepare_inputdata <- function(data, time, status, variable, model,
                              na.action) {
