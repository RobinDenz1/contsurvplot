...
test_that("variable not in cox model", {
  expect_error(check_inputs_curve_cont(data=sim_dat,
                                       ...
                                       cif=FALSE,
                                       na.action="na.omit"),
               paste0("The column specified by the 'variable' argument needs",
                      " to be included as independent variable in",
                      " the coxph model."))
})
...
test_that("group not in cox model", {
  expect_error(check_inputs_curve_cont(data=sim_dat,
                                       ...
                                       cif=FALSE,
                                       na.action="na.omit"),
               paste0("The variable specified by 'group' needs to be included",
                      " as independent variable in the coxph model."))
})
